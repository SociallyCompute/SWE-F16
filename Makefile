...
# -----------------------------------------------
story: story.o bpbkt7.o tiit37.o wb334.o kbzg4.o yhcz4.o mjrqq3.o jbwy9b.o aardz6.o skinnerh.o kddth9.o tpwvyc.o drd436.o lxjq5d.o wlkr7.o jry83.o kcfk28.o cakd47.o btkvf.o kyw356.o
	$(CC) -o story $^
# -----------------------------------------------
...
cakd47.o: sentences/cakd47.c
	$(CC) -c $<
kyw356.o: sentences/kyw356.c/kyw356.c
	$(CC) -c $<
